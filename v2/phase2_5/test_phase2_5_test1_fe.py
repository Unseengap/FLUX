...
Loads Phase 2.5 checkpoint (FieldEvolutionGenerator) from HuggingFace.
Encodes test texts, uses prefix to predict next wave via field evolution, decodes it.
...
from train_field_evolution import (
...
def main():
    ...
    # Load trained FieldEvolutionGenerator
    ...
    print(f"  FieldEvolutionGenerator parameters: {n_params:,}")
    ...
    results = PhaseResults(phase=2, component_name="Field Evolution Decode Gate (Phase 2.5)")
    results.add_test(
