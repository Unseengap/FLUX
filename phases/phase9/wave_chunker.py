"""
Phase 9 — WaveChunker: Segment CSE Wave Sequences into Word-Level Chunks
...
class WaveChunker(nn.Module):
    ...
    def forward(
        ...
        for i in range(len(boundaries)):
            ...
            # Compress chunk to single wave via mean pooling + learned projection
